...
if var_npudriver == 1:
    ...
    for img_file in all_files:
        ...
        print(scores)
        if flag:
            for box,class1,score in zip(boxes, classes, scores):
                if score>=0.8:
                    ans.append(1)
                    break
        else:
...
camserver_ret = None
can_ret = None'''
    print('total images : %s,acc : %s%%.' % (image_length, len(ans)/image_length*100))
